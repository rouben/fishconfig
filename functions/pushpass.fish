function pushpass --description="Updates pass store with all remotes defined in git working copy"
...
#		end
		pass git remote | grep -v all | xargs -L1 -I R pass git push R master
	else
